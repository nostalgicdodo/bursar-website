		...
		<div class="row">
			<div class="columns small-offset-1 small-10 medium-offset-0 medium-12 large-8">
				...
				<div class="columns small-12 medium-7 space-150-bottom">
					...
					<div class="p text-black">Bursar Tech Solutions Pvt Ltd, Prestige Central, 36, Infantry Rd, Tasker Town, Shivaji Nagar, Bengaluru, Karnataka 560001, India.</div>
				</div>
				<!-- <div class="row"></div> -->
			</div>
				...
				<div class="row space-50-top">
					...
					<nav class="columns small-12 medium-4 large-12">
						...
						<ul class="p strong text-indigo-2">
							...
							<li><a class="space-25-top-bottom" target="_blank" href="/terms-of-service">Terms of Service</a></li>
						</ul>
					</nav>
				</div>
			</div>
